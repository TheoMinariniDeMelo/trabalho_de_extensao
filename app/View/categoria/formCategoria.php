<div class="d-flex justify-content-center align-items-center mt-5">
    <div class="card shadow-lg p-4" style="max-width: 1200px; width: 100%; border-radius: 1rem;">
        ...
        <div class="text-center mb-4">
            <h3 class="fw-bold mb-0">Cadastro de Categoria</h3>
            <hr>
        </div>
        ...
        <form method="POST" action="<?= $this->request->formAction() ?>">
            ...
            <div class="row">
                <div class="col-md-8 mb-3">
                    <label for="descricao" class="form-label fw-semibold">Descrição da Categoria</label>
                    <input type="text" class="form-control" id="descricao" name="descricao"
                        placeholder="Ex: Empresa de TI, Comércio, Saúde..."
                        maxlength="50" value="<?= setValor("descricao") ?>" required autofocus>
