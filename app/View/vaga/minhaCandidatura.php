        ...
        <table style="
            ...
            <thead style="background-color: #2980b9; color: white;">
                <tr>
                    ...
                    <th style="padding: 12px 15px; text-align:left;">Título da Vaga</th>
                    ...
                    <th style="padding: 12px 15px; text-align:center;">Remover candidatura</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($candidaturas as $index => $candidatura): ?>
                    <tr style="background-color: <?= $index % 2 === 0 ? '#f7f9fb' : 'white' ?>;">
                        <td style="padding: 10px 15px; text-align:center; color:#34495e; font-weight: 600;"><?= $index + 1 ?></td>
                        <td style="padding: 10px 15px; color:#2c3e50; font-weight: 600;"><?= htmlspecialchars($candidatura['cargo_descricao']) ?></td>
                        ...
                        <td style="padding: 10px 15px; text-align:center; font-weight: 600; color:
                            ...
                            switch ($candidatura['status']) {
                                case 1:
                                    echo '#f39c12';
                                    break; // Pendente - amarelo
                                case 2:
                                    echo '#27ae60';
                                    break; // Aprovado - verde
                                case 3:
                                    echo '#c0392b';
                                    break; // Rejeitado - vermelho
                                default:
                                    echo '#7f8c8d';
                            }
                            ?>
